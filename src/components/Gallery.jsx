...
const Gallery = () => {
    ...
    return (
        <div className="py-20 px-4 sm:px-6 lg:px-8 bg-nature-50 min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-4xl font-serif font-bold text-nature-900 mb-4">Selected Works</h2>
                    <p className="text-nature-600 max-w-2xl mx-auto">A collection of moments from the wild.</p>
                </motion.div>
            ...
            <AnimatePresence>
                {selectedImage && (
                    ...
                    >
                        <button
                            className="absolute top-4 right-4 text-white hover:text-nature-300 transition-colors"
                            onClick={() => setSelectedImage(null)}
                        >
                            <X className="h-8 w-8" />
                        </button>
