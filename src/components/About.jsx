    ...
    return (
        <div className="py-20 px-4 sm:px-6 lg:px-8 bg-nature-50 min-h-screen flex items-center">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <h2 className="text-4xl font-serif font-bold text-nature-900 mb-6">Behind the Lens</h2>
                    <p className="text-lg text-nature-700 mb-6 leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-8">
                        <div className="text-center p-4 bg-nature-100 rounded-lg">
                            <span className="block text-3xl font-bold text-nature-800">5+</span>
                            <span className="text-sm text-nature-600">Years Experience</span>
                        </div>
                        <div className="text-center p-4 bg-nature-100 rounded-lg">
                            <span className="block text-3xl font-bold text-nature-800">50+</span>
                            <span className="text-sm text-nature-600">Species Documented</span>
                        </div>
                    </div>
                </motion.div>
            </div>
